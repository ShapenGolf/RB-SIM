...
- **233 Karten** von Hand implementiert, der Reihe nach ab Origins
...
- Macht **393 von 1019 Karten (~39%) vollständig spielbar.**
- **626 Karten** bleiben als Sonderfall in `src/cards/data/special-cases-todo.json`.
