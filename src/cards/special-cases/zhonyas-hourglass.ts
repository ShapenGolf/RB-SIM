 ...
 *
 * [Hidden]'s face-down timing isn't modeled — armed as soon as it's in play. Uses
 * `preventsAllyDeathHere`, checked at the top of game/combat.ts destroyInstance; destroying
