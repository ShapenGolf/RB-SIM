...
- **168 Karten** von Hand implementiert (`src/cards/special-cases/`), Origins
  zuerst, der Reihe nach, jetzt auch Proving Grounds — siehe
  `src/cards/data/special-case-assignments.json`.
- Macht **328 von 1019 Karten (~32%) vollständig spielbar.**
- **691 Karten** noch offen (`src/cards/data/special-cases-todo.json`) — ihr
